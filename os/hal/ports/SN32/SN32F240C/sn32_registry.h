...
/**
 * @file    SN32F240C/sn32_registry.h
 * @brief   SN32F24xC capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
/**
 * @name    SN32F24xC capabilities
 * @{
 */

/* Common identifier of all SN32F24xC devices.*/
#if !defined(SN32F240C) || defined(__DOXYGEN__)
#define SN32F240C
#endif
...
#define SN32_I2C1_GLOBAL_NUMBER    I2C1_IRQn
...
#define SN32_FLASH_LINE_SIZE 1U
#define SN32_FLASH_NUMBER_OF_BANKS 1
#define SN32_FLASH_SECTORS_PER_BANK 128U
