...
#define PIN_CFG1_PULLUP(n)       (0U << (((n-16)*2))) // Pull-up
#define PIN_CFG1_SCHMITT_EN(n)   (2U << (((n-16)*2))) // Floating
#define PIN_CFG1_SCHMITT_DIS(n)  (3U << (((n-16)*2))) // Input buffer disconnected, alway read as zero.
...
#define VAL_GPIOA_CFG1 \
    ( PIN_CFG1_SCHMITT_EN(GPIOA_PIN16) \
    | PIN_CFG1_SCHMITT_EN(GPIOA_PIN17) \
    | PIN_CFG1_SCHMITT_EN(GPIOA_PIN18) \
    | PIN_CFG1_SCHMITT_EN(GPIOA_PIN19) )
...
#define VAL_GPIOB_CFG1 \
    ( PIN_CFG1_SCHMITT_EN(GPIOB_PIN16) \
    | PIN_CFG1_SCHMITT_EN(GPIOB_PIN17) \
    | PIN_CFG1_SCHMITT_EN(GPIOB_PIN18) \
    | PIN_CFG1_SCHMITT_EN(GPIOB_PIN19) )
...
#define VAL_GPIOD_CFG1 \
    ( PIN_CFG1_SCHMITT_EN(GPIOD_PIN16) \
    | PIN_CFG1_SCHMITT_EN(GPIOD_PIN17) \
    | PIN_CFG1_SCHMITT_EN(GPIOD_PIN18) \
    | PIN_CFG1_SCHMITT_EN(GPIOD_PIN19) )
